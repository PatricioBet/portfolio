...
const MongoIcon = (props) => (
  <svg viewBox="0 0 24 24" {...props}><path fill="#4DB33D" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm3.5 15.5c-.83.83-1.95 1.3-3.5 1.3s-2.67-.47-3.5-1.3c-.83-.83-1.3-1.95-1.3-3.5s.47-2.67 1.3-3.5c.83-.83 1.95-1.3 3.5-1.3s2.67.47 3.5 1.3c.83.83 1.3 1.95 1.3 3.5s-.47 2.67-1.3 3.5z"/></svg>
);

const skills = [
  { name: 'Python', icon: <PythonIcon className="h-12 w-12" /> },
  { name: 'JavaScript', icon: <JsIcon className="h-12 w-12" /> },
  { name: 'React', icon: <ReactIcon className="h-12 w-12" /> },
  { name: 'Node.js', icon: <NodeIcon className="h-12 w-12" /> },
  { name: 'Java', icon: <JavaIcon className="h-12 w-12" /> },
  { name: 'MongoDB', icon: <MongoIcon className="h-12 w-12" /> },
];
...
const Skills = () => {
  ...
  return (
    <section id="skills" className="py-20 bg-background/50 dark:bg-dark-background/50">
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-3xl font-bold text-center mb-12">{t('skills_title')}</h2>
          <motion.div 
            className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-8 max-w-4xl mx-auto"
          ...
          >
            {skills.map((skill) => (
              <motion.div
                key={skill.name}
                className="flex flex-col items-center justify-center p-4 rounded-lg bg-card dark:bg-dark-card shadow-md hover:shadow-xl transition-shadow"
                variants={itemVariants}
              >
                {skill.icon}
                <p className="mt-4 font-semibold text-card-foreground dark:text-dark-card-foreground">{skill.name}</p>
              </motion.div>
            ))}
          </motion.div>
        </motion.div>
...
// Exportamos los iconos para que otros módulos (Projects.jsx, ...)
export { 
  PythonIcon, 
  JsIcon, 
  ReactIcon, 
